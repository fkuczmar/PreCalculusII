...
Include three snapshots in your solution. One that shows how you determined the possible positions of point $C$, and two others that show the two possibilities for triangle $\Delta ABC$ along with the relative position vectors. 

(b) Use the law of cosines to find all possible distances from $B$ to $C$. Solve the resulting equation by completing the square. Give exact distances. Do not use a calculator. Do not use the quadratic formula.

(c) Use a calculator to approximate the distances in part (b) to the nearest hundreth of a mile.

(d) Use the results of part (c) to find all possibilities for the bearing of $C$ relative to $A$ to the nearest hundredth of a radian.

(e) Summarize your conclusions regarding the position $C$ relative to $A$.
