...
\begin{question}
The bottom end of an $L$ foot long ladder slides along the ground. The top end slides along a track making an angle of $\phi$ radians with the ground. The ladder rotates at the constant rate of $\omega$ rad/sec and lies on the ground at time $t=0$ seconds past noon.

Parameterize the motions of the two ends of the ladder in terms of the number of seconds past noon.


\pdfOnly{
Access Desmos interactives through the online version of this text at
 
\href{https://www.desmos.com/calculator/huijxki4s7}.
}
 
\begin{onlineOnly}
    \begin{center}
\desmos{huijxki4s7}{900}{600}
\end{center}
\end{onlineOnly}

Access Desmos interactive at

\href{https://www.desmos.com/calculator/huijxki4s7}{142: Rotating Ladder}
