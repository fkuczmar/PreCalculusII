...
We wish to describe the position of $A$ relative to $C$ by find the distance between $A$ and $C$ and the bearing of the direct path from $C$ to $A$.

(a) Use the application below to draw an accurate picture. Include the three vectors that describe the relative positions above. Include this as part of your solution.
...
(b) Find the exact distance between $A$ and $C$. Do not use a calculator. Explain your method.

(c) Find the exact bearing. Do not use a calculator. Explain your method.

(d) Use a calculator to approximate the distance in part b) to the nearest hundredth of a mile and the bearing in part c) to the nearest hundredth of a radian. Summarize your description of the position of $A$ relative to $C$.
...
\href{https://www.desmos.com/calculator/sbl80vami2}.
}
 
\begin{onlineOnly}
    \begin{center}
\desmos{sbl80vami2}{900}{600}
\end{center}
\end{onlineOnly}
