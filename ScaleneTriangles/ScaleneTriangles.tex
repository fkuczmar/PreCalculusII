...
(d) Use the results of part (c) to find all possible bearings of $C$ relative to $A$ to the nearest hundredth of a radian. 

(e) Summarize your conclusions regarding the position $C$ relative to $A$. Use the radian protractor to check your results.
