...
(a) Express the bearing $\theta_2$ of the sailboat in terms of $v$, $k$, $\theta_1$, and $\theta_2$. Consider all possibilities.

(b) Express the time of the collision in terms of $v$, $k$, $\theta_1$, and $\theta_2$. Consider all possibilities.

(c) Under what condition do the boats collide?

(d) Under what condition is there a unique collision point?

(e) Establish a rectangular coordinate system with the positive $x$-axis pointing due east, and at the motorboat's position at noon. 
Then parameterize the motions of the motorboat and sailboat. Consider all possibilities.
