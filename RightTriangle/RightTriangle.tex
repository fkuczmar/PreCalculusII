...
(b) Express the distance $s$ between the buildings in terms of the height $h$ of the neighboring building and the angles $\theta_1$, $\theta_2$.

(c) Express the height $H$ (in feet) of your eyes above the ground in terms of $h$, $\theta_1$, and $\theta_2$.
