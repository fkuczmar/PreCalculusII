...
You then walk away from the building, measure the angle of elevation to the top to be $0.6$ radians, and compute the height of the building again.
 ...
 Use the above expression (\ref{Eq:Error65}) to approximate the two errors in computing the height. Aassume a maximum error of $\pm 0.1$ radians in measuring the two angles of elevation. 
