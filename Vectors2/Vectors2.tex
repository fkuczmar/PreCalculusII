...
\begin{enumerate}
\item Given the vectors ${\bf u}$ and ${\bf v}$ above, express the vectors ${\bf q}$, ${\bf w}$, ${\bf z}$, and ${\bf j}$ in terms of ${\bf u}$ and ${\bf v}$. Note that ${\bf w}$ bisects the angle between ${\bf u}$ and ${\bf v}$. Note also that ${\bf j}$ is perpendicular to ${\bf w}$. 

\item Turn off the Folder \emph{Vectors 1} in Line 1 and activate the folder \emph{General Vector} in Line 11. Then express vector ${\bf p}$ in terms of the vectors ${\bf u}$ and ${\bf v}$ and the angle $\theta$.
