...
We wish to express the coordinates of a point $P$ on the circle in terms of its distance from $A$, measured counterclockwise around the circle. In the worksheet below, for example, $P$ is 11cm from $A$. But we'll work in general and assume the (signed) distance between $P$ and $A$ is $s$ cm. 
