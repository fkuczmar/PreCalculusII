...
\begin{align*}
    \overrightarrow{OP} & = \langle  8\cos\theta, 13 + 8 \sin\theta \rangle \\
                                  & = \langle  8\cos \left(  \arctan \left(-\frac{1}{4}\right) -  \frac{\pi}{6} \left(t-3\right) \right), 13 + 8 \sin \left( \arctan \left(-\frac{1}{4}\right) -  \frac{\pi}{6} \left(t-3\right) \right) \rangle .
\end{align*}
...
\[
   h = f(t) =  13 + 8 \sin \left( \arctan \left(-\frac{1}{4}\right) -  \frac{\pi}{6} \left(t-3\right) \right) \, , \, 0\leq t \leq  24,
\]
