...
\item Use your functions from parts (a) and (b), the protractor of 5 cm in this example, and four-function arithmetic to answer the following questions. Activate the \emph{Protractor} folder in Line 15 of the worksheet above \emph{only if you get stuck.} 
\begin{enumerate}
