...
\item Use the previous results to find the exact bearing of the direct path from $B$ to $C$, measured counterclockwise from the east. 
...
A tree leans precariously (or maybe impossibly) with its trunk making at an angle of $\alpha = \arcsin(1/2)$ radians with the ground. The bottom end of a 10-foot ladder is 16 feet from the base of the trunk and the top end rests against the trunk. How far is the top end from the trunk's base? 
...
\href{https://www.desmos.com/calculator/a1lr8gkfgz}{142: Ladder and Tree 2}
