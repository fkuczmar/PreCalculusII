...
\item Drag the slider $u$ in Line 2 in the exploration below to slide the ladder and approximate the distance from its top end to the trunk's base? Find all possibilities.

\item Use the law of cosines in $\Delta ABT$ to find the exact distance(s) from the top of the ladder to the base of the tree. Do this by completing the square. Do \emph{not} use the quadratic formula.

\item Use a calculator to approximate the distance(s) in part (b). Compare with your estimates in part (a).

\item Use the law of sines in $\Delta ABT$ to find the exact distance(s) from the top of the ladder to the base of the tree. Then use a calculator to approximate these distances.
