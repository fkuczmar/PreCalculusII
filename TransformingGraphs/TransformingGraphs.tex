...
\[
      y = f(t) = \textcolor{purple}{1} \sin (\textcolor{red}{t}) \, , \, t\in \mathbb{R}
\]
to the graph of
\[
...
\[
   2t = \frac{t}{1/2}
\]
stretches the graph $y=f(t)$ about the vertical ($y$) axis by a factor of $1/2$ (or compresses the graph about that axis by a factor of $2$.)
