...
\item Use the radian protractor above to approximate the two smallest angles in part (d). Then use these to approximate the first two times the block has position $x=1.4$ meters.
