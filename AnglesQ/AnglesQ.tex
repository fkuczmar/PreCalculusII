...
\item Two ships are on the same circle of latitude $3500$ miles apart. One ship is at a latitude of $0.5$ radians north of the equator. Find all possible latitudes for the second ship. % Give exact answers without a calculator. %Then approximations to the nearest tenth of a degree.
