...
Partial information is given below regarding three uniform circlular motions. Describe (in words) possible counterclockwise and clockwise motions for each. Then find the missing coordinate function for each of your descriptions.

(a) $x=f(t) = 5 + 3 \cos \left( \frac{2}{5}t \right)$

(b) $y = g(t) = 8 + 3 \sin \left( \frac{2\pi}{5}t \right)$

(c) $x=f(t) = 5 - 3 \cos \left( \frac{\pi}{12}\left( t-12 \right) \right)$
