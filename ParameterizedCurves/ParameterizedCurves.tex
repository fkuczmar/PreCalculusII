...
%\begin{question}
%Find the domain of the coordinate functions. Assume $k>0$. What is the domain if $k<0$?
%\end{question}
...
(b) Keeping  $a_1 = -1$ and $a_2=-4$, set $c_1=3$ in Line 37.  

\pskip

(c) Set $c_1=0$, keep $a_1 = -1$ and $a_2=-4$, and set $k=1/2$.

\pskip

(d) Keep $c_1=0$, $a_1 = -1$ and $a_2=-4$, and set $k=-2$.
...
\href{https://www.desmos.com/calculator/okrwn25mqg}.
}
 
\begin{onlineOnly}
    \begin{center}
\desmos{okrwn25mqg}{900}{600}
\end{center}
\end{onlineOnly}
\end{exploration}
...
\begin{exploration}\label{exp:pc14}
 Find expressions (in terms of $f$ and $g$) for the coordinate functions $x=f_3(t)$ and $y=g_3(t)$ that give a counterclockwise motion around Path 3 over the time interval $0\leq t \leq 9$ starting at the point $(2,-4)$. Explain your reasoning, emphasizing where you had trouble. Do {\bf not} open the folder for Path 3. Then check your work by entering the coordinate functions in Lines 52 and 53. Adjust the sliders for the parameters and play the slider for $w$ on Line 54.


\pdfOnly{
Access Desmos interactives through the online version of this text at
 
\href{https://www.desmos.com/calculator/zo6wkilcvz}.
}
 
\begin{onlineOnly}
    \begin{center}
\desmos{zo6wkilcvz}{900}{600}
\end{center}
\end{onlineOnly}
\end{exploration}
