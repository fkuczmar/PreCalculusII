...
\]
express the coordinates (in cm) of a beetle crawling in the $xy$-plane in terms of the number of seconds past noon. The graphs of these functions are shown below.
