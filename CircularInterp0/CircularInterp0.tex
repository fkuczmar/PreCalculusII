...
We'll make the same assumptions as in Example 1, as well as assuming the number of hours of daylight/day in Fairbanks AK varies between a minimum of $4$ hours/day and $20$ hours/day.
...
Use \emph{only the protractor above} to help answer the following questions.
