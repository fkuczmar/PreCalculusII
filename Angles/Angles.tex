...
To answer this question, imagine drawing a circle of say radius $r$ meters about yourself. Now stand in place and turn through one revolution as your gaze sweeps out the entire circle. So to compute the number of radians in one revolution, divide the circumference of the circle by its radius. That dimensionless ratio gives you the radain measure of one revolution. It measures the number of radii that wrap around a circle's circumference.
