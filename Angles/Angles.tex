...
\begin{expandable}
Euclid: WHen a straight line standing on a straight line makes the adjacent angles equal to one another, ecah of the angles is \emph{right}, and the straight line standing on the other is called a \emph{perpendicular} to that on which it stands.
\end{expandable}
\end{question}
...
Do \emph{not} use any trigonometric functions. Think proportionately instead.
\end{enumerate}
...
\href{https://www.desmos.com/calculator/vb1kvzkzlq}{142:Radian Protractor}
...
You and your friend jog counterclockwise around a circlular track, you in the inner most lane, your friend in the outermost lane. These lanes are $3$ meters apart. You jog at the constant speed of $5$ m/sec, your friend at the constant speed of $3$ m/sec.

\begin{enumerate}
\item Suppose you pass each other every $6$ minutes. 
\end{enumerate}
\end{question}
