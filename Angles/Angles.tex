...
On the spring equinox at the equator the sun rises due east at 6:00am, passes directly overhead at noon, and sets due west at 6:00pm. You both watch the sun set into the ocean. Being west of your friend, you see the sun set later. How much later? Well it depends on the distance between you and your friend.

\pdfOnly{
Access Desmos interactives through the online version of this text at
 
\href{https://www.desmos.com/calculator/gqbliszzd8}.
}
 
\begin{onlineOnly}
    \begin{center}
\desmos{gqbliszzd8}{900}{600}
\end{center}
\end{onlineOnly}
