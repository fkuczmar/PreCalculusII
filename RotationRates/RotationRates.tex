...
There is a subtle assumption in the previous question, that the wheel rolls on a flat road. But what if that's not true, like the wheel rolling on a hill as illustrated below where the wheel rolls through its circumference at a constant rate?

\begin{onlineOnly}
    \begin{center}
\desmos{4jjyxdervc}{900}{600}
\end{center}
\end{onlineOnly}


\href{https://www.desmos.com/calculator/j4jjyxdervc}{142: Wheel Rolling on a Hill}
