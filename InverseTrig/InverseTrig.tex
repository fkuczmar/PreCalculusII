...
\]
Now the vectors $\overrightarrow{AB}$ and $\overrightarrow{AC}$ are symmetric about the origin. This means (picture left for you) that $\overrightarrow{AB}$ has a polar angle with a radian measure of 
\[
   \theta = \pi + \arctan  \left( - \frac{3}{5}  \right)  = \pi - \arctan  \left( \frac{3}{5}  \right).
\] 
