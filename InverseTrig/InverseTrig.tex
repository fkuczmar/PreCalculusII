...
(b) Use a calculator to approximate (to the nearest hundredth) all solutions $t\in [110, 116]$ of the equation in part (i) above. Some explanation required here.
...
The function
\[
  h = f(t) = 2500 - 200 \cos \left(  \frac{\pi}{6} \sqrt{t}  \right) \, , 0\leq t \leq 144 ,
\]
expresses the height (in feet) of a balloon in terms of the number of minutes past noon.

\pskip

(a) Find a function $t=u(h)$ that expresses the time (measured in minutes past noon) in terms of the balloon's height when the balloon is ascending. Include the correct domain.

(b) Find a function $t=d(h)$ that expresses the time (measured in minutes past noon) in terms of the balloon's height when the balloon is descending. Include the correct domain.
