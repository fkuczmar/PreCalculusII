...
To determine the value of $\theta$, we'll work on the unit circle and start by stetching the angle
\[
     \frac{7\pi}{5} = \pi + \frac{2\pi}{5}
\]
...
\[
 \arccos (\cos (7\pi/5)) = 2\pi -  \frac{7\pi}{5} = \frac{3\pi}{5}.
\]
