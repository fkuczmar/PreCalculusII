...
Point $B$ is 5 miles from $A$ at a bearing of $2$ radians. Point $C$ is $8$ miles from $A$ at a bearing of $5$ radians. 
...
\item Describe  the position of $C$ relative to $B$ in the two ways of Example \ref{Edsa5454v:Vectors}:
...
Follow all the steps in the previous example, making modifications as necessary. Create an accurate picture using the geogebra worksheek inExample \ref{Edsa5454v:Vectors}.
