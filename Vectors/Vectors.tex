...
\item By giving the exact distance from $C$ to $C$ and an approximate bearing (measured counterclockwise from the east). For the bearing we will use the worksheet below. But it would be best to click the link just above the worksheet and work in Geogebra directly. That way you'll be able to zoom in and out.
\end{enumerate}
