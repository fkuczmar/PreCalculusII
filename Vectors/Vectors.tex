...
Point $C$ lies at a bearing of $0.9$ radians from $B$ and is 7 miles from $B$.

Use vectors (and not triangle trigonometry) to find the exact distance between $B$ and $C$. Start by defining an unknown. Use the worksheet in Example 10 to check your work.
